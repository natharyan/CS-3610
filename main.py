...
# ---------------------------- #
    ...
    if (message1 == decryptedAB):  # Decode bytes to string
...
# ---------------------------- #
    ...
    subroutines.certificate.signCertificateRequest(csrpath=certificatesdir + '/' + subdirA + '/csr.pem', ca_cert_path=certificatesdir + '/' + subdirCA + '/' + "selfsigned.crt", ca_key_path=keystore + '/' + subdirCA + '/' + "private.key", certpath=certificatesdir + '/' + subdirA, serialnumber=1234)
...
# ---------------------------- #
    ...
    subroutines.certificate.signPublicKey(user="A",publickeypath=keystore + '/' + subdirA + '/public_key.pem', cacertpath=certificatesdir + '/' + subdirCA + '/' + "selfsigned.crt", cakeypath=keystore + '/' + subdirCA + '/' + "private.key", capassphrase=passphraseCA, certpath=certificatesdir + '/' + subdirA, serialnumber=1235)
